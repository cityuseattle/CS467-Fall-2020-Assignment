...
- ```mkdir CS467```(to create a directory for this course)<br/>
- ```cd CS467``` (to change directory to CS467 folder you just created) <br/>
...
- ```git pull https://github.com/cityuseattle/CS467-Fall-2020-Assignment.git``` (to get the most updated content from source repository). If you are prompted to type a message, you can skip this by typing ```:wq``` + ```Enter```  <strong> !!! NOTE: FOR EACH WEEK, YOU NEED TO DO THIS STEP BEFORE YOU START CODING)!!! </strong>
...
KimNguyen/Desktop/CS467/CS467-HOP-Hands-On-Practice-KimNguyenMai/Module 1 <br/>
